...
# ────────────────────────────────────────────────
INPUT_EXCEL     = "Cartoonxlsx.xlsx"           # Your input file
OUTPUT_EXCEL    = "updated_videos_with_links.xlsx"
OUTPUT_M3U      = "all_channels_playlist.m3u8"
...
def main():
    ...
    if len(valid) == 0:
        logging.warning("No valid m3u8 links to create playlist.")
        return
